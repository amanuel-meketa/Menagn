...
import { TemplateHubPreviewComponent } from './features/template-hub/components/template-hub-preview/template-hub-preview';
...
export const routes: Routes = [
  { path: '', component: LayoutComponent, children: [
      ...
      { path: 'role-register', component: RoleRegisterComponent},
      { path: 'role-details/:id', component: RoleDetailsComponent},
      { path: 'role-update', component: RoleUpdateComponent},
      { path: 'role-assigned-users', component: RoleAssignedUsersComponent},
      ...
      { path: 'template-hub-preview/:key', component: TemplateHubPreviewComponent},
